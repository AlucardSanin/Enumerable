...
# 📖 [morse] <a name="about-project"></a>

This is a test project to test our skills in ruby and also to learn how to work with it
...
To use this project you must install Ruby on your computer
...
Feel free to check the [issues page](https://github.com/AlucardSanin/Enumerable/issues/1)
...
- **Is this project a practice?**
  ...
  - Yes, it is. The main reason of this project is to practice and learn the basics of Ruby.

- **Where can i learn more about SQL?**

  - The best way to learn Ruby and go deeper in knowledge is directly in Microverse or Ruby documentation.
